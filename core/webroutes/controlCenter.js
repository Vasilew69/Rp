const modulename = 'WebServer:ControlCenter';
import consoleFactory from '@extras/console';
const console = consoleFactory(modulename);

/**
 * Returns the output page containing the ControlCenter (index)
 * @param {object} ctx
 */
export default async function ControlCenter(ctx) {
    ...
    //Rendering the page
    return ctx.utils.render('main/controlcenter', renderData);
};
